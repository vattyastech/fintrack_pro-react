...
const Expance = () => {
  ...
  const expenseTransection = transection.filter(
                ...
                >
                  ...
                  <td>
                    <button
                      onClick={() => {
                        setIsOpenPopup(true);
                        setSelectedTransection(trans);
                      }}
                      className="px-5 py-2 mt-2 text-gray-600 dark:text-gray-300 bg-orange-500 rounded-2xl"
                    >
                      Edit
                    </button>
                  </td>
